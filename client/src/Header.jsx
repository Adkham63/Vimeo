      ...
      <div className="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <nav className="flex items-center gap-8">
          ...
          >
            ...
            <span className="font-medium">Учебные пособия</span>
          </Link>
          ...
          >
            ...
            <span className="font-medium">Обновления</span>
          </Link>
          <Link
            to="/forum"
          ...
          {user?.isAdmin && (
            ...
            >
              ...
              <span className="font-medium">Новый пост</span>
            </Link>
          )}
        </nav>
          ...
          >
            {user ? (
              ...
              <>
                ...
                <span className="font-medium">Войти в систему</span>
              </>
            )}
          </Link>
        </div>
